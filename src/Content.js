...
const social_media = [
  {
    text: "mailtosayuru@gmail.com",
    icon: GrMail,
    link: "mailto:souhaibemanah@gmail.com",
  },
  {
    text: "Sayuru Samarawickrama",
    icon: AiFillLinkedin,
    link: "https://www.linkedin.com/in/sayuru-samarawickrama-87ba75342/",
  },
  {
    text: "Sayuru Samarawickrama",
    icon: AiFillGithub,
...
const cert_content = [
  ...
  /*
  {
    title: "Oracle Certified Professional, dsdsdsdd",
    link: "https://www.bing.com/images/search?view=detailv2&form=SBIHVR&lightschemeovr=1&iss=SBI&q=imgurl:https%3A%2F%2Fudemy-certificate.s3.amazonaws.com%2Fimage%2FUC-8f3da0eb-a8be-4af8-8a35-a5e44a0dd000.jpg%3Fv%3D1735756757000&pageurl=https%3A%2F%2Fwww.udemy.com%2Fcertificate%2FUC-8f3da0eb-a8be-4af8-8a35-a5e44a0dd000%2F&pagetl=Udemy+Course+Completion+Certificate+%7C+Udemy&imgsz=945x704&selectedindex=0&id=https%3A%2F%2Fudemy-certificate.s3.amazonaws.com%2Fimage%2FUC-8f3da0eb-a8be-4af8-8a35-a5e44a0dd000.jpg%3Fv%3D1735756757000&ccid=O1JGxGaP&mediaurl=https%3A%2F%2Fudemy-certificate.s3.amazonaws.com%2Fimage%2FUC-8f3da0eb-a8be-4af8-8a35-a5e44a0dd000.jpg%3Fv%3D1735756757000&exph=1190&expw=1600&vt=3&sim=11&cal=0&cab=1&cat=0&car=1",
    image:
      "https://www.udemy.com/certificate/UC-8f3da0eb-a8be-4af8-8a35-a5e44a0dd000/",
  },
  {
...
export const content = {
  en: {
    ...
    hero: {
      ...
      hero_content: [
        {
          text: " B.Sc (Hons) Computer Science Undergraduate - York University ",
        },
        /* {
          count: "1+",
          text: "Years of Experience in Web development And  Programming ",
        },*/
        {
          count: "7+",
      ...
      skills_content: [
        {
          ...
          para: "Used React, Javascript, CSS, Node.js, MongoDB",
          logo: mongodb,
        },
        {
          name: "CampusLink App Development",
          para: "React Native, Firebase, Expo, Python ",
          logo: python,
        },
        {
          name: "Diet and Exercise Journal Application",
          para: "MySQL, Java, Structural Design Patterns ",
          logo: java,
        },
        {
          name: "JavaScript | Node Js | Express",
          para: "with React & Next js & Node js",
          logo: nodejs,
        },
        {
          name: "Python",
          para: "Python Libraries for Data Science Numpy, Pandas, scikit-learn ,PyTorch",
          logo: python,
        },
        {
          name: "Data Structure | Problem Solving | ",
          para: "Big O notation,Data structures,Algorithms (Searching-Sorting)",
          logo: datastructure,
        },
        ...
        {
          name: "Docker",
          para: "Docker Desktop, Docker Compose",
          logo: docker,
        },
    ...
    Projects: {
      ...
      project_content: [
        {
          title:
            "SaaS Insurance Platform for Football Clubs using machine learning and blockchain",
          image: aman,
    ...
    Aboutme: {
      ...
      para: "B.Sc (Hons) Computer Science Undergraduate | Web & Mobile App Developer | React & React Native Enthusiast | UI/UX Designer with Figma Expertise | Pursuing AWS Certifications in AI, Machine Learning, and Data Science",
  ...
  fr: {
    ...
    hero: {
      ...
      hero_content: [
        {
          count: `+${
            new Date(new Date() - new Date("2024-01-01")).getFullYear() - 1970
          }`,
